...
-- Dumping structure for table poslasticarnica.contact_addresse
CREATE TABLE IF NOT EXISTS `contact_addresse` (
...
-- Dumping data for table poslasticarnica.contact_addresse: ~0 rows (approximately)
